      ...
      const backgroundWork = async () => {
        try {
          ...
          if (RESEND) {
            ...
            // Nota: el aviso al admin de "paso 1 sin completar" ahora se envía
            // desde send-plan-prueba-recovery, en el mismo momento en que se
            // manda el correo de recuperación al usuario (>1h sin completar).
          }
