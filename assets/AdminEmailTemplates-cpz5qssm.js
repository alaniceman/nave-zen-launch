import{c as S,r as h,j as a,l as C}from"./index-CsCqslgu.js";import{C as l,c as d,a as x,b as f}from"./card-CAofvHWx.js";import{T as E,a as $,b,d as v}from"./tabs-YPTNywvB.js";import{B as y}from"./badge-B5qfAkww.js";import{S as T,a as D,b as k,c as H,d as j}from"./select-BPrcdbgC.js";import"./index-Bgp6EWv-.js";import"./index-CzFCM8nQ.js";import"./chevron-up-C26hS4sx.js";import"./check-YVa3tlQh.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const N=S("Eye",[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]),r="https://maps.app.goo.gl/oW6G58gLd5oYWmGn8",i="https://wa.me/56946120426",s={name:"María González",email:"maria@ejemplo.com",phone:"+56912345678",classTitle:"Vinyasa Yoga",formattedDate:"Miércoles 12 de marzo de 2026",time:"19:00",professionalName:"Alan",serviceName:"Vinyasa Yoga",startTime:"19:00",endTime:"20:15"},z={...s,classTitle:"Método Wim Hof + Ice Bath",serviceName:"Método Wim Hof + Ice Bath",startTime:"10:00",endTime:"12:00",time:"10:00"},n=`body{margin:0;padding:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;background:#f5f5f5}
...
.footer{padding:24px;text-align:center;color:#999;font-size:13px;border-top:1px solid #eee}`;function q(e){const o=e.toLowerCase();return o.includes("wim hof")||o.includes("ice bath")||o.includes("baño de hielo")||o.includes("criomedicin")}function F(e){return q(e)?`
...
</div></body></html>`}function L(e){return`<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">
<style>${n}</style></head><body>
...
<div class="wrap">
  ...
  <div class="footer">Nave Studio · Antares 259, Las Condes</div>
</div></body></html>`}function R(e){const o=F(e.serviceName);return`<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">
<style>${n}</style></head><body>
...
<div class="wrap">
  ...
  <div class="footer">Nave Studio · Antares 259, Las Condes</div>
</div></body></html>`}function V(e){const o=F(e.serviceName);return`<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">
<style>${n}</style></head><body>
...
<div class="wrap">
  ...
  <div class="footer">Nave Studio · Antares 259, Las Condes</div>
</div></body></html>`}const c=[{id:"trial-confirmation",name:"Confirmación de Clase de Prueba",subject:"Confirmación — tu clase de prueba en Nave Studio",category:"trial",description:"Se envía inmediatamente al agendar una clase de prueba.",buildHtml:()=>P(s)},{id:"trial-reminder-3d",name:"Recordatorio 3 Días Antes (Prueba)",subject:"En 3 días es tu clase de prueba — deja todo listo",category:"trial",description:"Se envía automáticamente 3 días antes de la clase de prueba.",buildHtml:()=>L(s)},{id:"trial-reminder-1d",name:"Recordatorio 1 Día Antes (Prueba)",subject:"Mañana es tu clase de prueba — recordatorio rápido",category:"trial",description:"Se envía automáticamente 1 día antes de la clase de prueba.",buildHtml:()=>W(s)},{id:"trial-reminder-3h",name:"Recordatorio 3 Horas Antes (Prueba)",subject:`Hoy ${s.time} — tu clase de prueba (dirección rápida)`,category:"trial",description:"Se envía automáticamente 3 horas antes de la clase de prueba.",buildHtml:()=>M(s)},{id:"booking-confirmation-yoga",name:"Confirmación de Reserva",subject:"Confirmación — tu reserva en Nave Studio",category:"booking",description:"Se envía al confirmar el pago de una sesión.",buildHtml:e=>R(e==="wimhof"?z:s)},{id:"booking-reminder",name:"Recordatorio 24h Antes",subject:"Mañana es tu sesión — recordatorio",category:"booking",description:"Se envía automáticamente 24 horas antes de la sesión pagada.",buildHtml:e=>V(e==="wimhof"?z:s)}];function A({html:e}){return a.jsx("iframe",{srcDoc:e,className:"w-full border rounded-lg bg-white",style:{height:720},sandbox:"allow-same-origin",title:"Email preview"})}function J(){const[e,o]=h.useState(c[0]),[p,w]=h.useState("yoga"),m=c.filter(t=>t.category==="trial"),u=c.filter(t=>t.category==="booking");return a.jsxs("div",{className:"space-y-6",children:[a.jsxs("div",{className:"flex items-center gap-3",children:[a.jsx(C,{className:"h-7 w-7 text-primary"}),a.jsxs("div",{children:[a.jsx("h1",{className:"text-2xl font-bold text-gray-900",children:"Plantillas de Email"}),a.jsx("p",{className:"text-sm text-muted-foreground",children:"Vista previa de todos los correos automáticos del sistema"})]})]}),a.jsxs(E,{defaultValue:"trial",className:"space-y-4",children:[a.jsxs($,{children:[a.jsxs(b,{value:"trial",children:["Clases de Prueba (",m.length,")"]}),a.jsxs(b,{value:"booking",children:["Sesiones Pagadas (",u.length,")"]})]}),a.jsx(v,{value:"trial",className:"space-y-4",children:a.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-4 gap-4",children:[a.jsx("div",{className:"space-y-2",children:m.map(t=>a.jsx(l,{className:`cursor-pointer transition-all hover:shadow-md ${e.id===t.id?"ring-2 ring-primary":""}`,onClick:()=>o(t),children:a.jsxs(d,{className:"p-3",children:[a.jsx("p",{className:"font-semibold text-sm",children:t.name}),a.jsx("p",{className:"text-xs text-muted-foreground mt-1",children:t.description})]})},t.id))}),a.jsx("div",{className:"md:col-span-3",children:e.category==="trial"&&a.jsxs(l,{children:[a.jsx(x,{className:"pb-3",children:a.jsxs("div",{className:"flex items-center justify-between",children:[a.jsxs("div",{children:[a.jsxs(f,{className:"text-lg flex items-center gap-2",children:[a.jsx(N,{className:"h-4 w-4"}),e.name]}),a.jsxs("p",{className:"text-sm text-muted-foreground mt-1",children:[a.jsx("strong",{children:"Asunto:"})," ",e.subject]})]}),a.jsx(y,{variant:"secondary",children:"Clase de Prueba"})]})}),a.jsx(d,{children:a.jsx(A,{html:e.buildHtml("yoga")})})]})})]})}),a.jsx(v,{value:"booking",className:"space-y-4",children:a.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-4 gap-4",children:[a.jsxs("div",{className:"space-y-2",children:[u.map(t=>a.jsx(l,{className:`cursor-pointer transition-all hover:shadow-md ${e.id===t.id?"ring-2 ring-primary":""}`,onClick:()=>o(t),children:a.jsxs(d,{className:"p-3",children:[a.jsx("p",{className:"font-semibold text-sm",children:t.name}),a.jsx("p",{className:"text-xs text-muted-foreground mt-1",children:t.description})]})},t.id)),a.jsxs("div",{className:"pt-2",children:[a.jsx("label",{className:"text-xs font-medium text-muted-foreground mb-1 block",children:"Variante"}),a.jsxs(T,{value:p,onValueChange:t=>w(t),children:[a.jsx(D,{className:"w-full",children:a.jsx(k,{})}),a.jsxs(H,{children:[a.jsx(j,{value:"yoga",children:"🧘 Yoga"}),a.jsx(j,{value:"wimhof",children:"🧊 Wim Hof / Ice Bath"})]})]})]})]}),a.jsx("div",{className:"md:col-span-3",children:e.category==="booking"&&a.jsxs(l,{children:[a.jsx(x,{className:"pb-3",children:a.jsxs("div",{className:"flex items-center justify-between",children:[a.jsxs("div",{children:[a.jsxs(f,{className:"text-lg flex items-center gap-2",children:[a.jsx(N,{className:"h-4 w-4"}),e.name]}),a.jsxs("p",{className:"text-sm text-muted-foreground mt-1",children:[a.jsx("strong",{children:"Asunto:"})," ",e.subject]})]}),a.jsx(y,{variant:"outline",children:p==="wimhof"?"🧊 Wim Hof":"🧘 Yoga"})]})}),a.jsx(d,{children:a.jsx(A,{html:e.buildHtml(p)})})]})})]})})]})]})}export{J as default};
