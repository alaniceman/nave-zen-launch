        ...
        <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-10 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="text-neutral-mid mb-6 md:mb-8 max-w-prose font-inter">
              Acceso ilimitado a Yoga, Breathwork, Criomedicina y Método Wim Hof. Tú eliges cuándo empezar.
            </p>
            ...
            <div className="bg-warm/15 text-primary rounded-[10px] p-4 mb-6 md:mb-8 border border-warm/30">
              <p className="font-inter text-sm">
                Para ingresar al hielo después de Yoga debes haber realizado <strong>una sesión guiada del Método Wim Hof</strong> (puede ser dentro del mismo plan).
              </p>
            </div>
