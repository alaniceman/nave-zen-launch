        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 bg-white rounded-[10px] p-8 lg:p-10 shadow-sm animate-fade-in">
            <div className="text-primary">
              ...
              <div className="mb-6">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3329.845!2d-70.5182!3d-33.4102!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzPCsDI0JzM2LjciUyA3MMKwMzEnMDcuNCJX!5e0!3m2!1sen!2scl!4v1635123456789!5m2!1sen!2scl"
                  width="100%" 
                  height="220" 
                  loading="lazy" 
                  className="rounded-lg border"
                  title="Mapa de ubicación Nave Studio"
                ></iframe>
              </div>
