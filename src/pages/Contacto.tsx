...
const Contacto = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = `Hola! Mi nombre es ${formData.name}.%0A%0AEmail: ${formData.email}%0A%0AMensaje: ${formData.message}`
    const whatsappUrl = `https://wa.me/56946120426?text=${message}`
