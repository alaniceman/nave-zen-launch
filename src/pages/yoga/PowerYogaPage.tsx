...
const CANONICAL = "https://studiolanave.com/yoga/power-yoga-las-condes";
  ...
  const schedule = useMemo(() => {
    ...
    return DAY_ORDER.map((day) => {
      const items = (scheduleData.scheduleData[day] || [])
        .filter((item: any) => /Power Yoga/i.test(item.title) && !/Power Vinyasa/i.test(item.title))
      ...
      <main>
        <section className="relative min-h-[75vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
            ...
            <p className="text-base md:text-lg text-white/60 font-inter mb-10 tracking-wide">Fuerza, resistencia y determinación en cada postura</p>
        ...
        <section className="py-20 md:py-28 bg-background">
          <div className="container mx-auto px-6 max-w-4xl text-center">
            ...
            <p className="text-muted-foreground font-inter text-lg leading-relaxed max-w-3xl mx-auto">
              El {STYLE_NAME} lleva la energía del yoga a su máxima expresión física. Secuencias dinámicas con más repeticiones, sostenes más largos y transiciones exigentes que desarrollan fuerza, resistencia y estabilidad. Es yoga como entrenamiento: cada clase es un desafío que superas con la respiración como aliada.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 md:py-28 bg-muted">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground font-inter text-lg">Por qué el desafío transforma</p>
            </div>
