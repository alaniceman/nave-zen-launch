...
const CANONICAL = "https://studiolanave.com/yoga/integral-yoga-las-condes";
...
export default function IntegralYogaPage() {
  ...
  const schedule = useMemo(() => {
    ...
    return DAY_ORDER.map((day) => {
      const items = (scheduleData.scheduleData[day] || [])
        .filter((item: any) => /Integral/i.test(item.title))
    ...
    <>
      ...
      <main>
        <section className="relative min-h-[75vh] flex items-center justify-center overflow-hidden">
          <img src={HERO_IMAGE} alt={`Sala de ${STYLE_NAME} en Nave Studio Las Condes`} className="absolute inset-0 w-full h-full object-cover scale-105" {...({ fetchpriority: "high" } as any)} />
          ...
          <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
            ...
            <p className="text-base md:text-lg text-white/60 font-inter mb-10 tracking-wide">Fuerza, flexibilidad y meditación en una sola práctica</p>
        ...
        <section className="py-20 md:py-28 bg-background">
          <div className="container mx-auto px-6 max-w-4xl text-center">
            ...
            <p className="text-muted-foreground font-inter text-lg leading-relaxed max-w-3xl mx-auto">
              El {STYLE_NAME} integra las diferentes dimensiones del yoga en una sola sesión equilibrada: posturas de fuerza, secuencias de flexibilidad, ejercicios de respiración y momentos de meditación activa. Es la práctica ideal si quieres tocar todas las bases en una clase, sin perder profundidad en ninguna.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 md:py-28 bg-muted">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground font-inter text-lg">Una práctica que lo abarca todo</p>
            </div>
        ...
        <CoachesSection filterIds={["maral"]} />
