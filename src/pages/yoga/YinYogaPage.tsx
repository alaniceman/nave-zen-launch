...
const CANONICAL = "https://studiolanave.com/yoga/yin-yoga-las-condes";
const OG_IMAGE = "https://studiolanave.com/lovable-uploads/82672388-9723-4aee-a1f2-ac72618cd26a.png";

const benefits = [
  "Flexibilidad profunda y sostenida",
  "Relajación del sistema nervioso",
  "Liberación de fascia y tensión crónica",
];

const audience = [
  "Personas con estrés o ansiedad acumulada",
  "Quienes buscan recuperar movilidad articular",
  "Practicantes de deportes intensos que necesitan recuperación activa",
  "Cualquiera que quiera aprender a escuchar su cuerpo",
];
  ...
  const schedule = useMemo(() => {
    ...
    return DAY_ORDER.map((day) => {
      const items = (scheduleData.scheduleData[day] || [])
        .filter((item: any) => /Yin Yoga/i.test(item.title))
      ...
      <main>
        ...
        <section className="relative min-h-[75vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
            ...
            <p className="text-base md:text-lg text-white/60 font-inter mb-10 tracking-wide">Posturas pasivas, respiración profunda y calma activa</p>
        ...
        <section className="py-20 md:py-28 bg-muted">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground font-inter text-lg">Por qué incluirlo en tu rutina semanal</p>
            </div>
