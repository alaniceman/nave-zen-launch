          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
              <div className="rounded-2xl border bg-card p-5">
                ...
                <p className="text-xs text-muted-foreground mt-1">¿Primera vez? Prueba con el <a href="/plan-de-prueba" className="text-accent underline">Plan de Prueba desde $14.900</a>.</p>
        ...
        <section className="py-8 px-4 md:px-6">
          <div className="max-w-5xl mx-auto bg-card rounded-2xl p-5 shadow-sm border">
            ...
            <div className="mt-3 flex flex-wrap gap-3">
              <a href="https://maps.app.goo.gl/PvKkqNvETsDZEAGFA" target="_blank" rel="noopener" className="inline-block border-2 border-primary text-primary rounded-lg px-4 py-2 hover:bg-primary hover:text-primary-foreground transition">Ver mapa</a>
