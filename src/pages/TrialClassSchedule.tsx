...
export default function TrialClassSchedule() {
  ...
  useEffect(() => {
    trackViewContentOnce('Clase de prueba', { contentCategory: 'trial_class' });
  }, []);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Agenda tu clase de prueba en Nave Studio. Yoga, Breathwork y más en Las Condes." />
      </Helmet>
