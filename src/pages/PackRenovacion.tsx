...
const PACKAGE_NAME = "Pack Renovación · 6 Sesiones";
const SESSIONS = 6;
const PRICE = 60000;
...
export default function PackRenovacion() {
  ...
  return (
    <>
      <Helmet>
        <title>Pack 6 Sesiones · Renueva tu práctica | Nave Studio</title>
        <meta
          name="description"
          content="Pack exclusivo de 6 sesiones por $60.000 para Criomedicina / Método Wim Hof y Yoga en Nave Studio, Las Condes."
        />
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center max-w-3xl mx-auto">
              <div className="inline-flex items-center gap-2 bg-cyan-100 text-cyan-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
                ...
                <span>Un pack pensado para ti</span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4">
                Sigue entrenando el frío.{" "}
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto">
                Este pack solo existe en este link: 6 sesiones a{" "}
                <strong className="text-foreground">$10.000 cada una</strong>, para usar en
                Criomedicina / Método Wim Hof o en Yoga. Y si quieres, compártelas.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold text-center text-foreground mb-3">
                El cambio está en la constancia.
              </h2>
